...
//Name: camera example scene - maya 2013.ma
//Last modified: Fri, Mar 29, 2013 11:00:29 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -n "circularCameraArray";
	...
	setAttr ".r" -type "double3" -22.392252036556272 0.19620273923962203 -3.4298818247985704e-012 ;
...
createNode transform -n "circularCameraArray13";
	...
	setAttr ".r" -type "double3" 157.60774796344373 -50.196202739239453 180 ;
	setAttr ".s" -type "double3" 0.999999999999999 0.99999999999999989 0.99999999999999911 ;
...
createNode transform -n "circularCameraArray29";
	...
	setAttr ".r" -type "double3" -22.392252036556272 70.196202739239638 1.8335347697584233e-017 ;
...
createNode transform -n "circularCameraArray35";
	...
	setAttr ".r" -type "double3" -22.392252036556272 10.19620273923962 6.3116993715142503e-018 ;
...
createNode transform -n "arcCameraArray1";
	...
	setAttr ".r" -type "double3" -13.18445360380888 -29.856560572543486 4.0798701604863644e-014 ;
	setAttr ".s" -type "double3" 1 0.99999999999999989 1 ;
...
createNode transform -n "arcCameraArray2";
	...
	setAttr ".r" -type "double3" -13.805837087542978 -24.916734698862872 -1.8060951930456954e-013 ;
...
createNode transform -n "arcCameraArray9";
	...
	setAttr ".r" -type "double3" -15.163850225773267 20.936258618718579 8.8539959848185891e-014 ;
...
createNode transform -n "arcCameraArray10";
	...
	setAttr ".r" -type "double3" -14.270870888461085 29.900978199044001 -4.5861659859908977e-015 ;
...
createNode makeNurbTorus -n "makeNurbTorus1";
	...
	setAttr ".nsp" 4;
	setAttr ".hr" 0.5;
createNode makeNurbTorus -n "makeNurbTorus2";
	setAttr ".ax" -type "double3" 0 1 0 ;
	setAttr ".nsp" 4;
	setAttr ".hr" 0.5;
...
connectAttr "makeNurbTorus2.os" "nurbsTorusShape2.cr";
...
// End of camera example scene - maya 2013.ma
